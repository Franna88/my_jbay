...
class BecomeBusinessMember extends StatelessWidget {
  final String businessName = 'Business Name';
  const BecomeBusinessMember({super.key});
      ...
      body: SingleChildScrollView(
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              // Stack for back button and title
              Stack(
                children: [
                  // Back Button
                  Positioned(
                    ...
                    child: IconButton(
                      ...
                      onPressed: () {
                        // Access the NavbarVisibilityProvider and show the navbar
                        final navbarProvider =
                            Provider.of<NavbarVisibilityProvider>(context,
                                listen: false);
                        navbarProvider.showNavbar(); // Show the navbar

                        // Pop back to TouristSettings
                  ...
                  Padding(
                    padding:
                        const EdgeInsets.only(left: 40.0, top: 30, right: 20),
                    child: Center(
                      child: Text(
