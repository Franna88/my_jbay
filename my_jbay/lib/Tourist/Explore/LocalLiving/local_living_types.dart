...
class LocalLivingTypes extends StatelessWidget {
  final String title;
  const LocalLivingTypes({super.key, required this.title});
    ...
    final List<Map<String, dynamic>> business = [
      {
        ...
        'title': 'Local Living 1',
      },
      {
        'imagePath': 'images/business_listing.png',
        'title': 'Local Living 2',
      },
      {
        'imagePath': 'images/business_listing.png',
        'title': 'Local Living 3',
      },
      {
        'imagePath': 'images/business_listing.png',
        'title': 'Local Living 4',
      },
      {
        'imagePath': 'images/business_listing.png',
        'title': 'Local Living 5',
      },
      {
        'imagePath': 'images/business_listing.png',
        'title': 'Local Living 6',
      },
      {
        'imagePath': 'images/business_listing.png',
        'title': 'Local Living 7',
      },
      {
        'imagePath': 'images/business_listing.png',
        'title': 'Local Living 8',
      },
