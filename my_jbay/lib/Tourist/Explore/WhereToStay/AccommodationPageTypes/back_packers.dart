...
class BackPackers extends StatelessWidget {
  const BackPackers({super.key});
    ...
    final List<Map<String, dynamic>> business = [
      {
        ...
        'title': 'Back Packers 1',
      },
      {
        'imagePath': 'images/business_listing.png',
        'title': 'Back Packers 2',
      },
      {
        'imagePath': 'images/business_listing.png',
        'title': 'Back Packers 3',
      },
      {
        'imagePath': 'images/business_listing.png',
        'title': 'Back Packers 4',
      },
      {
        'imagePath': 'images/business_listing.png',
        'title': 'Back Packers 5',
      },
      {
        'imagePath': 'images/business_listing.png',
        'title': 'Back Packers 6',
      },
      {
        'imagePath': 'images/business_listing.png',
        'title': 'Back Packers 7',
      },
      {
        'imagePath': 'images/business_listing.png',
        'title': 'Back Packers 8',
      },
